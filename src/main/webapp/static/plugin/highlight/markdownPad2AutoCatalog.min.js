...
window.onload = function () {
    ...
    */
    function createContent() {
        ...
        //6.底部提示
        // let msg1 = '<div style="text-align: center;font-size:12px;color:#999;margin-top:60px;padding-top:10px;border-top:1px solid #ccc">Powered by Lu Zhuohuan</div>';
        // let msg2 = '<div style="text-align: right;font-size:12px;color:#999;margin-top:60px;padding-top:10px;border-top:1px solid #ccc">目录插件：<a href="https://github.com/cayxc/MarkdownPad2AutoCatalog" target="_blank"> GitHub地址</a>&emsp;<a href="https://gitee.com/cayxc/MarkdownPad2AutoCatalog" target="_blank">Gitee地址</a></div>'
        let msg1 = '<p class="note-tips"><div class="col-sm-4"></div><div class="col-sm-4" style="text-align:center;font-size:12px;color:#999;padding-bottom: 20px">Powered by Lu Zhuohuan</div>';
        let msg2 = '<div class="col-sm-4" style="text-align:right;font-size:12px;color:#999;">目录插件：<a href="https://github.com/cayxc/MarkdownPad2AutoCatalog" target="_blank"> GitHub地址</a>&emsp;<a href="https://gitee.com/cayxc/MarkdownPad2AutoCatalog" target="_blank">Gitee地址</a></div></p>';

        //let msg = '<p class="note-tips">' + msg1 + msg2 + '</p>';
        // let msg = '\n<p class="note-tips">\n' +
        //     msg1 + msg2 +
        //     '</p>\n';
        let msg =msg1 + msg2;
    ...
    */
    ...
    function childTagArr(tagObj) {
        ...
        if (level == 5) { // 第五级目录
            ...
            // 找到该目录下的子目录
            for (let i = 0, len = allChildTag.length; i < len; i++) {
